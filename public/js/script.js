(function() {
  // VARS
  const productsContainer = document.getElementById("aman");
  ...
  function displayCartTotal() {
    ...
    if (prices) {
      ...
      totalPriceContainer.innerHTML = `<span class="total">Total: Rs${total.toFixed(
        2
      )}</span>`;
    } else {
      totalPriceContainer.innerHTML = '<span class="total">Total: Rs0</span>';
    }
  }
